...
public class TestUsingFilters extends Base {
    ...
    @Test(alwaysRun = true, description = "Verify results include only selected range of Departure Times", dependsOnMethods = "testStep_2")
    ...
    @Test(alwaysRun = true, description = "Verify results include only selected range of Flight Duration", dependsOnMethods = "testStep_3")
